...
public class ApparatusController {//extends thriftTools
    ...
    private final String elementType = "_apparatus";
    ...
    public void selectByPageAndCondition(HttpServletRequest req, HttpServletResponse res, HttpSession session) throws ServletException, IOException {
        ...
        Search<Apparatus> searches = indicatorServiceImpl.selectApparatusMesByPageAndCondition(searchType,currentPage,pageSize,search);
